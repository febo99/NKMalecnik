...
if(empty($akcija))header("location: Delovne_akcije.php");
if($_SESSION['vloga'] != 1 && $_SESSION['vloga'] != 2)header("location: Delovne_akcije.php");
?>
  ...
  <div id="container">
    ...
    <div class="row kavarna">
      ...
      <div class="col-11 col-sm-11 order-sm-1  colKavarna novIgralec">
        <form id="novTrening" action="Uredi_akcijo.php" method="post" enctype="multipart/form-data">

          <div class="row">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
				  <input type="hidden" name=id value="<?php echo $idAkcije?>">
                <span class="input-group-text" id="inputGroup-sizing-sm">Naslov akcije*</span>
              </div>
              <input type="text" class="form-control" name="naslov" value="<?php echo $akcija['naslov'];?>">
            </div>
          </div>
          <div class="row">
            <div class="input-group mb-3">
              ...
              <input type="date" class="form-control"  name="datum" value="<?php echo $akcija['datum'];?>">
            </div>
          ...
          <div class="row">
            <div class="input-group mb-3">
              ...
              <input type="time" class="form-control" name="zacetek" id="zacetek" value="<?php echo $akcija['zacetek'];?>" required>
            </div>
          </div>
          <div class="row">
            <div class="input-group mb-3">
              ...
              <input type="time" class="form-control" name="konec" id="konec" value="<?php echo $akcija['konec'];?>" required>
            </div>
          </div>
          <div class="row">
            <div class="input-group mb-3">
              ...
              <textarea class="form-control" rows="5" name="porocilo" id=porocilo><?php echo $akcija['porocilo'];?></textarea>
            </div>
          </div>
