  ...
  $(function(){
    ...
    <div class="row" style="margin-top:0.5vh;margin-left:1vh;">
        <div class="col-11 col-sm-11 order-sm-1  colKavarna novIgralec">
    		<form id="novTrening" action="Dodaj_predlogo.php" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
              <span class="input-group-text" id="inputGroup-sizing-sm">Naslov*</span>
			</div>
			<input type="text" class="form-control"  required name="naslov" placeholder="Ime predloge">
            </div>
          </div>
          <div class="row">
            <div class="input-group mb-3">
